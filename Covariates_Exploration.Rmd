...
```{r include vars}
covars <- c("youthidCUF","classidCUF","schoolidCUF","schtype_geRV","y1_sex","y1_doby","y1_migage","y1_nationRV","y1_lpsc1","y1_lpsc2","y1_lpsc3","y1_lpsc4","y1_pmon","y1_pmonwRV","y1_pmonmRV","y1_fact","y1_sat2")
...
`y1_pmon` -- Do you get pocket money from your parents?
-   1 = yes, each week
-   2 = yes, each month
-   3 = 
